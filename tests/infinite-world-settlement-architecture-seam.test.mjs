  ...
  return {
    ...
    roadGraph: {
      nodes: [
        ...
        { nodeId: 'node-c', x: 12.5, z: -3.75 },
        { nodeId: 'node-d', x: 12.000001, z: -3.75 },
      ],
      edges: [
        { edgeId: 'edge-a', fromNodeId: 'node-a', toNodeId: 'node-b' },
        { edgeId: 'edge-b', fromNodeId: 'node-b', toNodeId: 'node-c' },
        { edgeId: 'edge-c', fromNodeId: 'node-c', toNodeId: 'node-d' },
        { edgeId: 'edge-d', fromNodeId: 'node-d', toNodeId: 'node-a' },
      ],
    },
    blocks: [{
      id: 'block-a',
      boundaryEdgeIds: ['edge-a', 'edge-b', 'edge-c', 'edge-d'],
      boundaryNodeIds: ['node-a', 'node-b', 'node-c', 'node-d', 'node-a'],
      isClosed: true,
      districtTag: null,
      sourceRoadGraphVersion: 'settlement-road-graph-v1',
    }],
